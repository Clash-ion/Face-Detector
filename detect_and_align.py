...
class Network(object):
    ...
    def conv(self, inp, k_h, k_w, c_o, s_h, s_w, name, relu=True, padding="SAME", group=1, biased=True):
        ...
        def convolve(i, k):
            return tf.nn.conv2d(input=i, filters=k, strides=[1, s_h, s_w, 1], padding=padding)
    ...
    def max_pool(self, inp, k_h, k_w, s_h, s_w, name, padding="SAME"):
        self.validate_padding(padding)
        return tf.nn.max_pool2d(input=inp, ksize=[1, k_h, k_w, 1], strides=[1, s_h, s_w, 1], padding=padding, name=name)
